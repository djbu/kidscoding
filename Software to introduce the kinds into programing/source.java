...
public class source {
    ...
    public class SuggestionPanel {
        ...
        private JList createSuggestionList(final int position, final String subWord) {
            ...
            Object[] data_show = new Object[10];
            data[0]="int";            
            data[1]="else";
            data[2]="while";
            data[3]="false";
            ...
            int j=0;
            	...
            	for (int i=0;i<5;i++){
            		if(subWord.length()<data[i].toString().length() && data[i].toString().indexOf(subWord)!=-1){
            			data_show[j]=data[i];
            			j++;
            ...
            JList list = new JList(data_show);
    ...
    protected void initUI() {
        ...
        frame.setTitle("probando autocompletado");
